<footer class="main-footer">
    <div class="row">
        <div class="col-md-6 p-2">
            ...
            <p class="mb-2"><a href="{{ route('privacypolicy') }}">Політика конфіденційності</a></p>
        </div>
        <div class="col-md-6 p-2">
            ...
            <p class="mb-2">Приймальня: <i class="fas fa-lg fa-phone"></i> (0332) 26-80-49 </p>
            <p class="mb-2">Тех.підтримка: <i class="fas fa-lg fa-phone"></i> +38 068 307 48 66 <i class="fas fa-lg fa-envelope"><b>&nbsp;info@vopas.com.ua</b></i> </p>
