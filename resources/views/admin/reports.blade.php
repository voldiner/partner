                                    ...
                                    @if($stationsSelected || $numberReport || $sum_report || $dateStart || $dateFinish)
                                        <div class="card card-gray rounded-pill">
                                            <div class="card-header rounded-pill">
                                                <p class="card-title">
                                                    <a class="btn btn-danger btn-sm" href="{{ route('manager.reports.index') }}">
                                    ...
                                    @forelse ($reports as $report)
                                        <div class="card card-info collapsed-card mb-1">
                                            <div class="card-header">
                                                ...
                                                <div class="row">
                                                    <div class="col-10 text-left ml-3">
                                                        <span style="font-weight: bold">{{ $report->user->full_name }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /.card-header -->
                                            <div class="card-body" style="display: none;">
                                                <div class="row">
                                                    @if($report->places_count > 0)
                                                        ...
                                                        @endif
                                                            <a class="btn btn-success" id="pdf-list" href="{{ route('manager.reports.show', $report->id) }}">
