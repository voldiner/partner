                                            ...
                                            @if($monthsSelected)
                                                @foreach($monthsSelected as $month)
                                                    <span class="badge badge-warning mt-1"
                                                          style="font-size: 100%;">{{ $month }}</span>
                                                @endforeach
                                            @endif
                                            @if($year)
                                                <span class="badge badge-warning mt-1"
                                                      style="font-size: 100%;">рік: {{ $year }}</span>
                                            @endif
                                        </p>
                            ...
                            @forelse ($invoices as $invoice)
                                <div class="card card-info collapsed-card mb-1">
                                    <div class="card-header">
                                        <div class="row justify-content-start">
                                            <div class="col-auto text-xl-left">
                                                <span style="margin-right: 15px;">{{ ($invoices->currentPage() - 1) * $invoices->perPage() + $loop->iteration }}
                                                    .</span>
                                                Акт виконаних робіт
                                            </div>
                                    ...
                                    <div class="card-body" style="display: none;">
                                        <div class="row">
                                            <div class="col-12">
                                                <p style="font-size: 120%;"><b> А К Т № {{ $invoice->number }}
                                                        від {{ $invoice->date_invoice->format('d.m.Y') }}</b></p>
                                                <p>м. Луцьк</p>
                                                <p>
                                                    приймання-здачі виконаних робіт та звірки взаємних розрахунків
                                                    станом на 1-е {{ $invoice->month_status  }}
                                                    {{ $invoice->year_status }} року.
                                                </p>
                                                <p>
                                                    Ми, що нижче підписалися, з однієї сторони ПрАТ "ВОПАС"
                                                    та {{ $invoice->user->full_name }} з другої
                                                    провели звірку взаємних розрахунків. При цьому встановлено наступне:
                                                </p>
                                                <p>
                                                    Згідно реєстрів
                                                    за {{ $monthsFromSelect[$invoice->month ] }} {{ $invoice->year }}
                                                    року за пасажирські
                                                    перевезення автобусами Вашого автопідприємства по відомостях касової
                                                    продажі за даними ПрАТ "ВОПАС":
                                                </p>
                                                <p style="font-size: 120%">
                                                    <b> Залишок на початок
                                                        місяця: {{ number_format($invoice->balance_begin, 2, '.', ' ')  }}</b>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <p>
                                                    Залишок на кінець місяця за даними {{ $invoice->user->full_name }}
                                                    ______________________
                                                </p>
                                                <p>
                                                    Таким чином в результаті звірки взаєморозрахунків встановлено
                                                    кінцеве сальдо
                                                ...
                                                <p>
                                                    Цей акт складений в двох примірниках, кожен з яких має однакову
                                                    силу.
                                                </p>
                                        ...
                                        <div class="row justify-content-between">
                                            <div class="col-md-4">
                                                ...
                                                <p class="mb-1">Ідентифікаційний
                                                    код {{ $invoice->user->identifier }}</p>
                                                @endexist
                                                @exist($invoice->user->certificate)
                                                <p class="mb-1">Номер свідоцтва {{ $invoice->user->certificate }}</p>
                                                @endexist
                                                @exist($invoice->user->certificate_tax)
                                                <p class="mb-1">Індивідуальний податковий
                                                    номер {{ $invoice->user->certificate_tax }}</p>
                                                @endexist
                                                ...
                                                <p>
                                                    <a class="btn btn-success" id="pdf-list"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <p class="mb-1"> р/р UA63033980000026009300331234, Волинське ОУ АТ
                                                    "Ощадбанк"</p>
                                                <p>
