...
<head>
    ...
    <title>Правила користування сервісом</title>
    <!-- Bootstrap CSS -->
...
<div class="row big-row p-2">
    <div class="col-sm-10 col-xl-6 offset-xl-3 offset-sm-1 white-col p-2 shadow-sm">
        ...
        <div class="row">
            ...
            <div class="col">
                Ці правила визначають порядок користування сервісом «Електронний кабінет перевізника» (надалі - Правила) і є обов'язковим для всіх користувачів електронного сервісу.
            </div>
        </div>
    </div>
</div>
...
<div class="row big-row p-2">
    <div class="col-sm-10 col-xl-6 offset-xl-3 offset-sm-1 white-col p-2 shadow-sm">
        ...
        <div class="row">
            ...
            <div class="col">
                Ознайомитися з <a href="{{ route('privacypolicy') }}">Політикою конфіденційності</a>, прийняти її та дотримуватись під час використання Сервісу;
            </div>
        </div>
        <div class="row">
